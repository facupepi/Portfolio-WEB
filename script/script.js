...
window.onload = function () {
    ...
    if (localStorage.getItem("mode") == "true" && LocationActual == "/Portfolio-WEB/projects.html") {
        document.getElementById("checkitem").checked = true;
        enableDarkMode_proyectos();
    } else if (localStorage.getItem("mode") == "true" && LocationActual == "/Portfolio-WEB/index.html") {
        document.getElementById("checkitem").checked = true;
        enableDarkMode();
    } else if (localStorage.getItem("mode") == "true" && LocationActual == "/Portfolio-WEB/education.html") {
        document.getElementById("checkitem").checked = true;
        enableDarkMode_education();
    } else if (localStorage.getItem("mode") == "true" && LocationActual == "/Portfolio-WEB/contact.html") {
        document.getElementById("checkitem").checked = true;
        enableDarkMode_contact();
    } else if (localStorage.getItem("mode") == "true" && LocationActual == "/Portfolio-WEB/aboutme.html") {
        document.getElementById("checkitem").checked = true;
